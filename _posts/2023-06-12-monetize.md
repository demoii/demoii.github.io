...
1. Assuming we have a 1MW, 1MWh battery. Try to design an charging/discharging algorithm to earn money with the battery asset. 
2. Assuming we have a 1MW, 2MWh battery. Try to design an charging/discharging algorithm to earn money with the battery asset. 
3. Assuming that each discharge operation by 1MWh costs 50 Euro, update the algorithm for charging/discharge. 
...
For every day in the data, find the optized times to charge and discharge the battery. 

Our methodology is largely based on the principle of buying (charging) low and selling (discharging) high. 
